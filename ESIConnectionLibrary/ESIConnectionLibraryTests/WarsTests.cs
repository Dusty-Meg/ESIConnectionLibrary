...
namespace ESIConnectionLibraryTests
{
    public class WarsTests
    {
        ...
        public void GetWars_successfully_returns_a_listInts()
        {
            ...
            mockedWebClient.Setup(x => x.Get(It.IsAny<WebHeaderCollection>(), It.IsAny<string>(), It.IsAny<int>())).Returns(warsJson);
        ...
        public async Task GetWarsAsync_successfully_returns_a_listInts()
        {
            ...
            mockedWebClient.Setup(x => x.GetAsync(It.IsAny<WebHeaderCollection>(), It.IsAny<string>(), It.IsAny<int>())).ReturnsAsync(warsJson);
        ...
        public void GetIndividualWar_successfully_returns_a_V1WarsIndividualWar()
        {
            ...
            mockedWebClient.Setup(x => x.Get(It.IsAny<WebHeaderCollection>(), It.IsAny<string>(), It.IsAny<int>())).Returns(warJson);
        ...
        public async Task GetIndividualWarAsync_successfully_returns_a_V1WarsIndividualWar()
        {
            ...
            mockedWebClient.Setup(x => x.GetAsync(It.IsAny<WebHeaderCollection>(), It.IsAny<string>(), It.IsAny<int>())).ReturnsAsync(warJson);
