...
namespace ESIConnectionLibrary.Internal_classes
{
    internal interface IInternalLatestCorporations
    {
        ...
        PagedModel<V2CorporationStructures> Structures(SsoToken token, long corporationId, int page);
        Task<PagedModel<V2CorporationStructures>> StructuresAsync(SsoToken token, long corporationId, int page);
