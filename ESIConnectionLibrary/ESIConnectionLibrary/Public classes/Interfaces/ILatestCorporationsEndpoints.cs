...
namespace ESIConnectionLibrary.Public_classes
{
    public interface ILatestCorporationsEndpoints
    {
        ...
        V1CorporationDivisions Divisions(SsoToken token, long corporationId);
        Task<V1CorporationDivisions> DivisionsAsync(SsoToken token, long corporationId);
        ...
        PagedModel<V3CorporationStructures> Structures(SsoToken token, long corporationId, int page);
        Task<PagedModel<V3CorporationStructures>> StructuresAsync(SsoToken token, long corporationId, int page);
