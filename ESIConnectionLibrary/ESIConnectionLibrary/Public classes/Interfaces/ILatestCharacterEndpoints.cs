...
namespace ESIConnectionLibrary.Public_classes
{
    public interface ILatestCharacterEndpoints
    {
        ...
        IList<V6CharactersNotifications> Notifications(SsoToken token);
        Task<IList<V6CharactersNotifications>> NotificationsAsync(SsoToken token);
        ...
        IList<V2CharactersResearchAgents> ResearchAgents(SsoToken token);
        Task<IList<V2CharactersResearchAgents>> ResearchAgentsAsync(SsoToken token);
